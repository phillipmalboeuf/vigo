<script lang="ts">
  ...
  function dispatchKey(key: ArrowKey, type: 'keydown' | 'keyup') {
  ...
  function releaseKey(key: ArrowKey) {
    dispatchKey(key, 'keyup');
  }

  function onPointerLeave(event: PointerEvent, key: ArrowKey) {
    if (event.buttons) releaseKey(key);
  }
</script>
...
<header class="padded flex flex--thick_gapped flex--middle flex--end">
  ...
  <a href="/gallery" title="Gallery" use:pageLink>
...
<figure class="logo">
  ...
  <svg width="115" height="74" viewBox="0 0 115 74" fill="none" xmlns="http://www.w3.org/2000/svg">
    <g
      ...
      onpointerleave={(event) => onPointerLeave(event, 'ArrowDown')}
    >
      <rect x="41.5" y="41.5" width="31" height="31.5" fill="transparent" />
    ...
    <g
      ...
      onpointerleave={(event) => onPointerLeave(event, 'ArrowUp')}
    >
      <rect x="41.5" y="1" width="31" height="31.5" fill="transparent" />
    ...
    <g
      ...
      onpointerleave={(event) => onPointerLeave(event, 'ArrowLeft')}
    >
      <rect x="1" y="41" width="31" height="31.5" fill="transparent" />
    ...
    <g
      ...
      onpointerleave={(event) => onPointerLeave(event, 'ArrowRight')}
    >
      <rect x="82" y="41" width="31" height="31.5" fill="transparent" />
